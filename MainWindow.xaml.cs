...
fix visibility settings to be cleaner (less lines)
fix button lock settings to be cleaner (toggle boolean, single method, less lines)
Associate com port with actual DI
Add not available on lower firmwares
*/
